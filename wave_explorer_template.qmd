...
params:
  wave: "W6"
  wave_file: "data/raw/W6_Cambodia_Release_20240819.sav"
---
...
```{r covid-variables}
# Find covid-related variables
covid_vars <- var_summary %>%
  filter(grepl("covid", var_label, ignore.case = TRUE))

datatable(covid_vars,
          options = list(pageLength = 10),
          caption = "COVID-related variables")
```
...
quarto::quarto_render(
  ...
  output_file = "wave6_explorer.html"
)
```
